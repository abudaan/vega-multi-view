      ...
      * [Configuration](#configuration)
         ...
         * [View specific configuration (ViewConfigType)](#view-specific-configuration-viewconfigtype)
            ...
            * [styling: StylingType](#styling-stylingtype-1)
               ...
               * [cssAppend: boolean](#cssappend-boolean-1)
         ...
         * [Data binding between views](#data-binding-between-views)
            * [1. replace a complete dataset](#1-replace-a-complete-dataset)
            * [2. change selected values](#2-change-selected-values)
         * [Tooltips](#tooltips)
